...
from game_agent import custom_score2a, custom_score2b, custom_score3a, custom_score3b
...
def main():
    ...
    # id_agent=[Agent(CustomPlayer(score_fn=improved_score, **CUSTOM_ARGS), "ID_Improved")]
    ...
    test_agents = [Agent(CustomPlayer(score_fn=improved_score, **CUSTOM_ARGS), "ID_Improved"),
                   ...
                   Agent(CustomPlayer(score_fn=custom_score2a, **CUSTOM_ARGS), "Student2a"),
                   Agent(CustomPlayer(score_fn=custom_score2b, **CUSTOM_ARGS), "Student2b"),
                   Agent(CustomPlayer(score_fn=custom_score3a, **CUSTOM_ARGS), "Student3a"),
                   Agent(CustomPlayer(score_fn=custom_score3b, **CUSTOM_ARGS), "Student3b")]
